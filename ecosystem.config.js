...
module.exports = {
  apps: [
    ...
    },
    {
      ...
      env: {
        ...baseEnv,
        PATH: '/data/home/zju321/miniconda3/envs/ai_agent/bin:/usr/local/bin:/usr/bin:/bin',
        PYTHONPATH: '/data/home/zju321/miniconda3/envs/ai_agent/lib/python3.9/site-packages',
        LOCAL_EMBEDDING_URL: 'http://127.0.0.1:9997',
      },
    },
  ],
}
