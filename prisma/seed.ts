    ...
    data: [
      {
        ...
        content: 'Transformer 是一种基于自注意力机制的深度学习架构，由 Vaswani 等人在 2017 年提出。它彻底改变了自然语言处理领域，并成为大语言模型的基础。',
        source: 'paper',
      ...
      {
        title: '量子计算入门指南',
        content: '量子计算利用量子力学原理进行计算，具有超越经典计算机的潜力。本文介绍量子比特、量子门和量子算法的基础知识。',
        source: 'manual',
        discipline: 'physics',
      ...
      {
        title: '深度学习中的优化算法',
        content: '优化算法是训练神经网络的核心。本文对比 SGD、Adam、AdamW 等常用优化器，分析它们的收敛特性和适用场景。',
        source: 'post',
        discipline: 'computer-science',
      ...
      {
        title: '学术写作规范与技巧',
        content: '高质量的学术写作是科研成果传播的关键。本文介绍论文结构、引用规范、图表制作等学术写作的核心要点。',
        source: 'wiki',
        discipline: 'social',
      ...
      {
        title: '石墨烯在光电子学中的应用',
        content: '石墨烯因其独特的能带结构和优异的光电特性，在光电子学领域展现出巨大潜力。本文综述了石墨烯光电探测器、调制器和激光器的研究进展。',
        source: 'paper',
        discipline: 'physics',
